package com.example.cloverestate.ui.theme.screens.map
...
@Composable
fun Room2screen(navController: NavHostController){
    BackHandler {
    ...
    Scaffold (
        ...
        content = @Composable {
            ...
            Column(
                ...
                Row {
                    Text(
                        text = "Rent at Ksh 140,000/month",
                        fontWeight = FontWeight.ExtraBold,
                        fontSize = 20.sp
                    )
                }
                ...
                Column {
                    Text(text = "1. six bedroom")
                    Text(text = "2. 24/7 survailance")
                    Text(text = "3. Electric fence")
                    Text(text = "4. Seven bathrooms")
                    Text(text = "4. Spaciuos")
                }
...
@Composable
@Preview
fun Room2screenpreview (){
    Room2screen(rememberNavController())
}
