package com.example.cloverestate.ui.theme.screens.room3
...
@Composable
fun Room3Screen(navController: NavHostController) {
    BackHandler {
...
@Preview
@Composable
fun Room3ScreenPreview() {
    Room3Screen(rememberNavController())
}
